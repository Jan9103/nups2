...
fn cli() -> std::io::Result<()> {
    ...
    match args.cmd {
        ...
        Commands::Pack2ScrapeFilenames {
            ...
            let filenames: Vec<String> = nups2::filename_extractor::extract_names(
                &pack2,
                &mut br,
                filesize_limit,
                scrape_mode,
        ...
        Commands::Pack2DiffWithManifest {
            ...
            println!(
                ...
                render_for_humans(
                    &diff,
                    &nups2::crc64::filename_list_to_lookup_table(&filename_list),
                )
            );
        }
        ...
        Commands::RainbowtableBuild {
            ...
            nups2::rainbow_table::build::build_table(
                &wordlist,
                &extlist,
                max_word_count,
                output_file.as_path(),
        ...
        Commands::RainbowtableFromFilenames {
            ...
            nups2::rainbow_table::build::convert_filename_list_to_rainbow_table_format(
